...
if __name__ == '__main__':
  ...
  parser.add_argument('--implicit_grad_clip' ,       type=lambda x: int(x) if x not in [None, "None"] else None,   default=10, help='Number of steps in CG/Neumann appproximation')
