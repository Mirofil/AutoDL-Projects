...
# python ./exps/NATS-algos/search-cell.py --dataset cifar10  --data_path $TORCH_HOME/cifar.python --algo random --rand_seed 3000 --cand_eval_method sotl --eval_epochs 1 --search_space_paper=nb101_3 --search_batch_size=64 --eval_candidate_num=200 --search_epochs=1 --steps_per_epoch=120 --save_archs_split=archs_nb101_3_random_200_seed3000.pkl
      ...
      for inner_step, (base_inputs, base_targets, arch_inputs, arch_targets) in tqdm(enumerate(zip(all_base_inputs, all_base_targets, all_arch_inputs, all_arch_targets)), desc="Iterating over inner batches", 
        ...
        for inner_sandwich_step in range(inner_sandwich_steps):
          ...
          if data_step < 2 and inner_step < 2 and epoch < 4 and outer_iter < 3:
            ...
            if xargs.inner_steps is not None and xargs.inner_steps > 1 and ('gdas' in xargs.algo or (xargs.meta_algo is not None and 'gdas' in xargs.meta_algo)):
